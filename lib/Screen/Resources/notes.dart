...
class _NotesState extends State<Notes> {
  ...
  final CollectionReference _notes = FirebaseFirestore.instance.collection('/$subjects/category/notes');
  final CollectionReference _pyq = FirebaseFirestore.instance.collection('/$subjects/category/pyq');
  final CollectionReference _videos = FirebaseFirestore.instance.collection('/$subjects/category/videos');
                ...
                SizedBox(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      ...
                      contentPadding: EdgeInsets.symmetric(vertical: SizeConfig.safeBlockVertical! *1.5),
                    ...
                    if(streamSnapshot.hasData){
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          ...
                          return ResourcesCard(title: documentSnapshot['title'], tutor: documentSnapshot['tutor'], likes: documentSnapshot['likes'], downloads: documentSnapshot['download'], subjects: subjects,);
